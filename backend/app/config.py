...
# Heartbeat-backed staff presence. Login timestamps are deliberately not used
# as an availability signal.
PRESENCE_ENABLED: bool = _env_bool("PRESENCE_ENABLED", True)
PRESENCE_TTL_SECONDS: int = int(os.getenv("PRESENCE_TTL_SECONDS", "90"))
PRESENCE_HEARTBEAT_SECONDS: int = int(os.getenv("PRESENCE_HEARTBEAT_SECONDS", "30"))
SLA_REPEAT_ALERTS_ENABLED: bool = _env_bool("SLA_REPEAT_ALERTS_ENABLED", True)
SLA_ALERT_REPEAT_SECONDS: int = int(os.getenv("SLA_ALERT_REPEAT_SECONDS", "3600"))
...
AI_ASSIGNMENT_CONFIDENCE_THRESHOLD: float = float(
    os.getenv("AI_ASSIGNMENT_CONFIDENCE_THRESHOLD", "0.75")
)
AI_ASSIGNMENT_MIN_SCORE_IMPROVEMENT: float = float(
    os.getenv("AI_ASSIGNMENT_MIN_SCORE_IMPROVEMENT", "8")
)
AI_ASSIGNMENT_MAX_TICKET_AGE_MINUTES: int = int(
    os.getenv("AI_ASSIGNMENT_MAX_TICKET_AGE_MINUTES", "5")
)
...
settings = types.SimpleNamespace(
    ...
    SLA_REPEAT_ALERTS_ENABLED=SLA_REPEAT_ALERTS_ENABLED,
    SLA_ALERT_REPEAT_SECONDS=SLA_ALERT_REPEAT_SECONDS,
    ...
    AI_MODEL=AI_MODEL,
    AI_ASSIGNMENT_REEVALUATION_ENABLED=AI_ASSIGNMENT_REEVALUATION_ENABLED,
    AI_ASSIGNMENT_CONFIDENCE_THRESHOLD=AI_ASSIGNMENT_CONFIDENCE_THRESHOLD,
    AI_ASSIGNMENT_MIN_SCORE_IMPROVEMENT=AI_ASSIGNMENT_MIN_SCORE_IMPROVEMENT,
    AI_ASSIGNMENT_MAX_TICKET_AGE_MINUTES=AI_ASSIGNMENT_MAX_TICKET_AGE_MINUTES,
    AI_ASSIGNMENT_REEVALUATION_MODE=AI_ASSIGNMENT_REEVALUATION_MODE,
